...
draw_text(window_get_width()/2, GRID_SIZE * 14, space_string);
draw_text(window_get_width()/2, GRID_SIZE * 15, esc_string);
...
if(array_length_1d(top_players) > 0){
	...
	draw_text(window_get_width()/2 - GRID_SIZE * 11, GRID_SIZE, "Loading scores" + dot_dot);
}
