...
var to_send = "/submit_data.php?name=" + global.user_name + "&time_alive=" + string(original_score) + "&beard_used_desc=" + scr_get_current_beard(BRD_BEARD_DESCRIPTION) + "&score=" + string(global.scr) + "&c_tally=" + string(global.cuntTally) + "&multiplier=" + string(global.black_drop_multiplier_max);
