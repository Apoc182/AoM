...
var current_ip = "175.36.17.125"

var to_send = "?name=" + global.user_name + "&time_alive=" + string(timer) + "&beard_used=" + scr_get_current_beard(BRD_BEARD_NAME) + "&score=" + string(global.scr);
